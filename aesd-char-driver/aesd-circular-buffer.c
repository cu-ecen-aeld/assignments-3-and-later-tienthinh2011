...
const char* aesd_circular_buffer_add_entry(struct aesd_circular_buffer *buffer, const struct aesd_buffer_entry *add_entry)
{
    ...
    */
    ...
    DEBUG_LOG("Add new entry size :%d at in_offs: %d; out_offs: %d, %s", 
        buffer->entry[buffer->in_offs].size, buffer->in_offs, 
        buffer->out_offs, buffer->entry[buffer->in_offs].buffptr);
